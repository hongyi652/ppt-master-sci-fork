...
```bash
${PYTHON} skills/ppt-master/scripts/svg_quality_checker.py "skills/ppt-master/templates/layouts/<template_id>" --template-mode --format <canvas_format>
```
...
```bash
${PYTHON} skills/ppt-master/scripts/register_template.py <template_id>
```
...
>
> ```bash
> ${PYTHON} skills/ppt-master/scripts/register_template.py --rebuild-all
> ```
